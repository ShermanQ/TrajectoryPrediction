...
############# Attention #########################################
        ...
        # apply multihead attention output d_model
        self.mha_s = MultiHeadAttention(self.device,self.h,self.dmodel,self.dk,self.dv,self.dropout_tfr)
...
############# Predictor #########################################
        ...
        self.predictor.append(nn.Linear(self.dmodel*3,self.predictor_layers[0]))
