...
#python learning/spatial_attention_training.py parameters/data.json parameters/model2a_training.json parameters/torch_extractors.json parameters/prepare_training.json "parameters/preprocessing.json"
...
def main():
    ...
    training_param = json.load(open("parameters/spatial_attention_training.json"))
    ...
    args = {
        ...
        "vgg_feature_size":training_param["vgg_feature_size"],
