...
# 10332
# 42.7 k
#python learning/s2s_spatial_attention_training.py parameters/data.json parameters/s2s_social_attention_training.json parameters/torch_extractors.json parameters/prepare_training.json
def main():
    ...
    training_param = json.load(open("parameters/s2s_spatial_attention_training.json"))
