...
def main():
    ...
    available_boxes = np.ones(line_count+1)
                ...
                if line_count_init != 0:
                    ...
                    with open(BOXES_PATH,'r') as csv_reader:
                        ...
                        while bframe < frame + NB_FRAME :
                            # print(bframe)
                            # print(frame)
                            # print(frame + NB_FRAME)
                            # print("-----")
                            # print(bframe)
                            ix = frame_to_line[frame] + current_line
                            if last_frame_added != bframe and available_boxes[ix] and bframe + 1 > frame: 
                                o = iou(box,bbox)
                                # print(box)
                                # print(bbox)
                                # print(o)
